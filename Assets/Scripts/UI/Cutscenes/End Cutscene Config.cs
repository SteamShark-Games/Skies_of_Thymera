...
public class SEndCutsceneConfig : DialogueViewBase
{
    ...
    // Dismisses canvas once dialogue is exhausted + brings player to Main Menu
    ...
    // Once the cutscene is finished or skipped, brings player to Main Menu
